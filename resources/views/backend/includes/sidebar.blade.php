  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{ Str::startsWith($currentUrl, 'admin/home') ? 'menu-is-opening menu-open' : ''}}">
        ...
        <li class="nav-item {{ Str::startsWith($currentUrl, 'admin/about') ? 'menu-is-opening menu-open' : ''}}">
          <a href="#" class="nav-link">
        ...
        <li class="nav-item {{ Str::startsWith($currentUrl, 'admin/service') ? 'menu-is-opening menu-open' : ''}}">
          <a href="#" class="nav-link">
        ...
        <li class="nav-item {{ Str::startsWith($currentUrl, 'admin/portfolio') ? 'menu-is-opening menu-open' : ''}}">
          <a href="#" class="nav-link">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{route("admin.category.index")}}" class="nav-link {{ request()->is('admin/portfolio/category') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>All Categories</p>
              </a>
            </li>
        ...
        <li class="nav-item {{ Str::startsWith($currentUrl, 'admin/contact') ? 'menu-is-opening menu-open' : ''}}">
          <a href="#" class="nav-link">
