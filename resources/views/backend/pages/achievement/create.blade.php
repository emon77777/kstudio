                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <form role="form" action="{{ route('admin.achievement.store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="amount">Amount (only number)</label>
                                            @if ($errors->first('amount'))
                                                <div class="text-danger py-0 px-1 mb-1">
                                                    Please enter valid amount
                                                </div>
                                            @endif
                                            <input type="text" required class="form-control" name="amount" id="amount" placeholder="Enter amount">
                                        </div>
