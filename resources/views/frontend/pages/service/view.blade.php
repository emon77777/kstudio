            ...
            <div class="col-lg-8">
                <div class="ltn__page-details-inner ltn__service-details-inner">
                    <div class="ltn__blog-img">
                        <img src="{{asset("frontend/img/service/21.jpg")}}" alt="Image">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="{{asset("frontend/img/service/31.jpg")}}" alt="image">
                            <label>Image caption here.</label>
                        </div>
                        <div class="col-lg-6">
                            <img src="{{asset("frontend/img/service/32.jpg")}}" alt="image">
                        </div>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
            ...
            <div class="col-lg-4">
                <aside class="sidebar-area ltn__right-sidebar">
                    ...
                    <div class="widget ltn__banner-widget">
                        <a href="shop.html"><img src="{{asset("frontend/img/banner/banner-1.jpg")}}"
                                alt="Banner Image"></a>
                    </div>
                </aside>
            </div>
